...
const data = {
 ...
 'zh-TW': {
   ...
   aboutData: {
     ...
     resume: 'https://joellyn.notion.site/Resume-Joellyn-8bc3079834dd44b6895af0995fb4610e',
   },
   projectsData: [
    {
      id: nanoid(),
      ...
      title: '個人部落格（2021）',
      info:
        '這個副業專案不只是個人部落格，更是一個運用 JAMstack 架構與靜態網站產生器打造的動態平台。設計包含吸睛的卡片輪播、分類標籤與直覺式操作。特別的是，即便不熟悉 markdown 語法或 Git 架構，也能透過整合的第三方 CMS，輕鬆創建與編輯內容。',
      info2: 'Gatsby.JS, GraphQL, NetlifyCMS, Netlify',
      url: 'https://susan8213.netlify.app',
    ...
    },
    {
      ...
      title: '網路爬蟲專案（2020）',
      info:
        '這個副業專案運用網頁爬蟲技術來自動化日常資訊整理。從多個新聞網站擷取資料後，分析與視覺化當日熱門關鍵字，一目瞭然地提供有價值的洞察。',
